...
powershell -Command "Invoke-WebRequest https://maven.fabricmc.net/net/fabricmc/fabric-installer/0.7.3/fabric-installer-0.7.3.jar -OutFile %TMP%\fabric.jar || echo [42mDownload Failed, please check your internet connection[0m && exit 1"
echo [92mInstalling fabric[0m
java -jar %TMP%\fabric.jar || echo [42mUnzip failed, do you have the correct permissions?[0m && exit 1
